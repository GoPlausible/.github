# Axios client — guide sample

The Axios client sample from https://facilitator.goplausible.xyz/guide:
wraps an axios instance so the 402 from the server is paid, verified and
settled in one call.
