...
GoPlausible has made the full core, tooling, and package support for Algorand (AVM) available as open source and contributed to the Algorand Foundation PR to Coinbase's x402 protocol repo: [CoinBse x402 PR #361](https://github.com/coinbase/x402/pull/361/)
